...
const productData = [
  { name:'Coveralls (Royal Blue)',   cat:'Uniforms',  price:'₱1,000',   img:'Assets/Products/UNI-PR1-Front-Coverall (Blue).png'   },
  { name:'Coveralls (Orange)', cat:'Uniforms',  price:'₱1,000', img:'Assets/Products/UNI-PR2-Front-Coverall (Orange).png' },
  { name:'Coveralls (Khaki)',  cat:'Uniforms',  price:'₱1,000',   img:'Assets/Products/UNI-PR3-Front-Coverall (Khaki).png'  },
  { name:"Chef's Polo Long Sleeve (Ver. 1)",   cat:'Kitchen',   price:'₱800',   img:'Assets/Products/UNI-PR4-Front-Top1.png'},
  { name:"Chef's Polo Long Sleeve (Ver. 2)",   cat:'Kitchen',   price:'₱950',   img:'Assets/Products/UNI-PR5-Front-Top2.png'},
  { name:"Kitchen Crew Polo",   cat:'Kitchen',   price:'₱800',   img:'Assets/Products/UNI-PR6-Front-Top3.png'},
  { name:"Chef's Pants",   cat:'Kitchen',   price:'₱500',   img:'Assets/Products/UNI-PR7-Front-Pants1.png'},
  { name:"Kitchen Crew Checkered Pants",   cat:'Kitchen',   price:'₱500',   img:'Assets/Products/UNI-PR8-Front-Pants2.png'},
  { name:"Winter Jacket",   cat:'Uniform',   price:'₱1,500',   img:'Assets/Products/UNI-PR9-Front-Jacket1.png'},
  { name:"Ordinary Jacket",   cat:'Uniform',   price:'₱1,500',   img:'Assets/Products/UNI-PR10-Front-Jacket2.png'},
  { name:"MG Safety (High Cut)",   cat:'Shoes',   price:'₱1,500',   img:'Assets/Products/SHO-PR1-Front-High Cut (MG Safety).png'},
  { name:"Rockwinner (Low Cut)",   cat:'Shoes',   price:'₱1,200',   img:'Assets/Products/SHO-PR2-Front-Low Cut (Rockwinner).png'},
  { name:"MG Safety (Low Cut)",   cat:'Shoes',   price:'₱1,200',   img:'Assets/Products/SHO-PR3-Front-Low Cut (MG Safety).png'},
